...
def capture_dynamic_gesture(csv_output_path):
    ...
    label_map = {str(i + 1): gesture for i, gesture in enumerate(label_handler.get_dynamic_gestures().keys())}
    capturing = False
    frame_counter = 0
...
if __name__ == "__main__":
    capture_dynamic_gesture('data/hand_gesture/data_dynamic.csv')
